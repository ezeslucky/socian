  ...
  return [
    ...(user?.allowTrial
      ? [
          {
            title: t(
              'faq_am_i_going_to_be_charged_by_socian',
              'Am I going to be charged by socian?'
            ),
            description: t(
              'faq_to_confirm_credit_card_information_socian_will_hold',
              'To confirm credit card information socian will hold $2 and release it immediately'
            ),
          },
        ]
      : []),
    {
      title: t(
        'faq_can_i_trust_socian_gitroom',
        `Can I trust ${isGeneral ? 'socian' : 'Gitroom'}?`
      ),
      description: t(
        'faq_socian_gitroom_is_proudly_open_source',
        `${
          isGeneral ? 'socian' : 'Gitroom'
        } is proudly open-source! We believe in an ethical and transparent culture, meaning that ${
          isGeneral ? 'socian' : 'Gitroom'
        } will live forever. You can check out the entire code or use it for personal projects. To view the open-source repository, <a href="https://github.com/ezeslucky/socian" target="_blank" style="text-decoration: underline;">click here</a>.`
      ),
    },
    {
      title: t('faq_what_are_channels', 'What are channels?'),
      description: t(
        'faq_socian_gitroom_allows_you_to_schedule_posts',
        `${
          isGeneral ? 'socian' : 'Gitroom'
