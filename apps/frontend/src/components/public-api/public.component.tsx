  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="text-customColor18 mt-[4px]">
        {t(
          'use_socian_api_to_integrate_with_your_tools',
          'Use socian API to integrate with your tools.'
        )}
        <br />
        <a
          className="underline hover:font-bold hover:underline"
          href="https://docs.socian.com/public-api"
          target="_blank"
        >
          {t(
        ...
        <a
          className="underline hover:font-bold hover:underline"
          href="https://www.npmjs.com/package/n8n-nodes-socian"
          target="_blank"
        ><br />
          {t(
            'check_n8n',
            'Check out our N8N custom node for socian.'
          )}
        </a>
      </div>
      ...
      <div className="text-customColor18 mt-[4px]">
        {t(
          'connect_your_mcp_client_to_socian_to_schedule_your_posts_faster',
          'Connect your MCP client to Socian to schedule your posts faster!'
        )}
      </div>
      <div className="my-[16px] mt-[16px] bg-sixth border-fifth items-center border rounded-[4px] p-[24px] flex gap-[24px]">
        <div className="flex items-center">
