  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="text-customColor18 mt-[4px]">
        {t(
          'webhooks_are_a_way_to_get_notified_when_something_happens_in_socian_via_an_http_request',
          'Webhooks are a way to get notified when something happens in Socian via\n        an HTTP request.'
        )}
      </div>
