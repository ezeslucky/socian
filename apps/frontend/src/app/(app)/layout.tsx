    ...
    <html>
      ...
      >
        <VariableContextComponent
          ...
          genericOauth={!!process.env.SOCIAN_GENERIC_OAUTH}
          oauthLogoUrl={process.env.NEXT_PUBLIC_SOCIAN_OAUTH_LOGO_URL!}
          oauthDisplayName={process.env.NEXT_PUBLIC_SOCIAN_OAUTH_DISPLAY_NAME!}
        ...
        >
          <SentryComponent>
            ...
            <FacebookComponent />
            <Plausible
              domain={!!process.env.IS_GENERAL ? 'socian.com' : 'gitroom.com'}
            >
              <PHProvider
