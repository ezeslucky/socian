  ...
  async approveOrDecline(email: string, action: string, id: string) {
    ...
    if (action === 'approve') {
      await this._notificationService.sendEmail(
        agency?.user?.email!,
        'Your Agency has been approved and added to Socian 🚀',
        `
<html lang="en">
...
<head>
    ...
    <title>Your Agency has been approved and added to Socian 🚀</title>
</head>

<body style="font-family: Arial, sans-serif; margin: 0; padding: 0;">
  Hi there, <br /><br />
  Your agency ${agency?.name} has been added to Socian!<br />
  You can <a href="https://socian.com/agencies/${agency?.slug}">check it here</a><br />
  It will appear on the main agency of Socian in the next 24 hours.<br /><br />
</body>
</html>`
      );
...
<body style="font-family: Arial, sans-serif; margin: 0; padding: 0;">
  Hi there, <br /><br />
  Your agency ${agency?.name} has been declined to Socian!<br />
    ...
    <table align="center" cellpadding="0" cellspacing="0" style="max-width: 600px; width: 100%; background-color: #ffffff; margin-top: 20px; border: 1px solid #ddd;">
        ...
        <tr>
            <td style="padding: 20px; text-align: center; background-color: #000;">
                <a href="https://socian.com/agencies/action/approve/${
                  agency.id
                }" style="margin: 0 10px; text-decoration: none; color: #007bff;">To approve click here</a><br /><br /><br />
                <a href="https://socian.com/agencies/action/decline/${
                  agency.id
